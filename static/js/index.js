...
const verificarImagenUser = () => {
    switch (user){
        case "piedra":
            userValue.setAttribute("src","/static/img/piedra.png")
            break
        case "papel":
            userValue.setAttribute("src","/static/img/papel.png")
            break
        case "tijeras":
            userValue.setAttribute("src","/static/img/tijeras.png")
            break
    }
...
const verificarImagenMaquina = () => {
    switch (maquina){
        case "piedra":
            maquinaValue.setAttribute("src","/static/img/piedra.png")
            break
        case "papel":
            maquinaValue.setAttribute("src","/static/img/papel.png")
            break
        case "tijeras":
            maquinaValue.setAttribute("src","/static/img/tijeras.png")
            break
    }
